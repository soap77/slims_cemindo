...
$sysconf['mail']['auth_username'] = 'cemindolib@gmail.com'; // SMTP account username
$sysconf['mail']['auth_password'] = 'cemindo123'; // SMTP account password
$sysconf['mail']['from'] = 'cemindolib@gmail.com';
$sysconf['mail']['from_name'] = 'Perpustakaan Cemindo Academy';
...
$sysconf['ipaccess']['general'] = 'all'; // do not change this unless you know what you are doing
$sysconf['ipaccess']['opac'] = 'all'; // do not change this unless you know what you are doing
$sysconf['ipaccess']['opac-member'] = 'all'; // do not change this unless you know what you are doing
...
$sysconf['OAI']['Identify']['repositoryName'] = 'Cemindo Academy Library Management System Repository';
$sysconf['OAI']['Identify']['adminEmail'] = 'cemindolib@gmailcom';
...
if (!defined('DB_NAME')) { define('DB_NAME', 'slims_cemindo'); }
