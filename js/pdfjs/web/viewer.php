...
<link rel="stylesheet" href="<?php echo JWB.'pdfjs/web/' ?>viewer.css"/>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="openFile" class="" title="Open File" tabindex="13" data-l10n-id="open_file">
                ...
                <button id="download" class="" title="Download" tabindex="15" data-l10n-id="download">
                  <span data-l10n-id=""></span>
                </button>
                <!-- <div class="toolbarButtonSpacer"></div> -->
...
<script type="text/javascript" src="<?php echo JWB.'pdfjs/web/'; ?>l10n.js"></script>
<script type="text/javascript" src="<?php echo JWB.'pdfjs/'; ?>build/pdf.js"></script>
<script type="text/javascript" src="<?php echo JWB.'pdfjs/web/' ?>debugger.js"></script>
<script type="text/javascript" src="<?php echo JWB.'pdfjs/web/' ?>viewer.js"></script>
</body>
</html>
