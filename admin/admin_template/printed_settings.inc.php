...
// Header Settings
$sysconf['print']['membercard']['front_header1_text'] = 'KARTU ANGGOTA'; // use <br /> tag to make another line
$sysconf['print']['membercard']['front_header1_font_size'] = '12';
$sysconf['print']['membercard']['front_header2_text'] = 'CEMINDO ACADEMY';
$sysconf['print']['membercard']['front_header2_font_size'] = '12';
$sysconf['print']['membercard']['back_header1_text'] = 'CEMINDO ACADEMY';
$sysconf['print']['membercard']['back_header1_font_size'] = "12";
$sysconf['print']['membercard']['back_header2_text'] = 'Ketentuan Anggota';
$sysconf['print']['membercard']['back_header2_font_size'] = "8";
$sysconf['print']['membercard']['header_color'] = "#ffffff"; //e.g. :#0066FF, green, etc.
...
// address
$sysconf['print']['membercard']['address'] = 'Perpustakaan PT CEMINDO GEMILANG<br />website: http://semenmerahputih.com/, email : librarian@slims.web.id';
