...
$menu[] = array(__('Loans by Main Classification'), MWB.'reporting/customs/loan_by_mainclass.php', __('Loan statistic by classification'));
$menu[] = array(__('Staff Activity Day'), MWB.'reporting/customs/staff_act_day.php',__('Staff Activity Day'));
