...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	*/
    ...
    $html_str .= 'h3{margin: 0px;font-weight: bold;text-align: center;padding-bottom:3px;font-size:'.$sysconf['print']['membercard']['back_header1_font_size'].'px;}'."\n";
    $html_str .= 'hr{margin: 0px;border: 1px solid '.$sysconf['print']['membercard']['header_color'].';position: relative;}'."\n";
    $html_str .= '#header1_div{z-index:2;position: absolute;left: 61px;top: 15px;width:245px;height: 45px;color:'.$sysconf['print']['membercard']['header_color'].';}'."\n";
    $html_str .= '#header2_div{z-index:3;position: absolute;left: 10px;top: 15px;width:300px;height: 43px;color:'.$sysconf['print']['membercard']['header_color'].';}'."\n";
    $html_str .= '#rules_div{z-index:4;position: absolute;left: 12px;top: 70px;width:300px;height: 142px;text-align: justify;}'."\n";
    ...
    $html_str .= '.bio_div{z-index:7;position: absolute;left: 0px;top:65px;height: 110px;margin: 0px;text-align: justify;}'."\n";
    ...
    foreach ($chunked_card_arrays as $membercard_rows) {
        ...
        foreach ($membercard_rows as $card) {
          ...
          $html_str .= '<div></div>';
          $html_str .= '<div id="logo_div"><img height="50px" width="50px" src="'.SWB.'files/membercard/'.$sysconf['print']['membercard']['logo'].'" /></div>';
          ...
          $html_str .= '<h3>'.$sysconf['print']['membercard']['back_header2_text'].'</h3></div>';
